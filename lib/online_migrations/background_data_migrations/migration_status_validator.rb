  ...
  module BackgroundDataMigrations
    ...
    class MigrationStatusValidator < ActiveModel::Validator
      ...
      VALID_STATUS_TRANSITIONS = {
        ...
        # enqueued -> pausing occurs when the migration is paused before starting.
        # enqueued -> cancelling occurs when the migration is cancelled before starting.
        ...
        "enqueued" => ["running", "pausing", "cancelling", "failed"],
